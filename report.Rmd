...
```
(ref:plot-openness-items) Pearson correlation of items testing the Big Five personality dimension "openness" before and after transforming items 2, 4 and 6.
...
```{r plot-openness, include=TRUE, fig.cap='(ref:plot-openness)', warning=FALSE}
